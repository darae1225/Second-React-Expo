...
const Register = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(error)
      if (error === "Invalid `password` param: Password must be between 8 and 265 characters long, and should not be one of the commonly used password.") {
        setError("'Password' entered is not valid. Password must be between 8 and 265 characters long.")
      }
    }
  }
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
     <ThemedView style={styles.container}>
        ...
        <Spacer />
        {error && <Text style={styles.error}>Error is {error}</Text>}
