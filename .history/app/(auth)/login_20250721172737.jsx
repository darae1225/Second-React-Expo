import { ActivityIndicator, ActivityIndicatorBase, Keyboard, Pressable, StyleSheet, Text, TextInput, TouchableWithoutFeedback, View, useColorScheme } from 'react-native'
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <ThemedView style={styles.container}>
        ...
        <ThemedButton onPress={handleSubmit}>
         <ThemedText style={{color: '#fefefe'}}>Login</ThemedText>
        </ThemedButton>
        ...
        <ThemedLink href="/register">
          <ThemedText style={{color: '#fefefe'}}>Register Instead</ThemedText>
        </ThemedLink>
      ...
      <ActivityIndicatorBase color="white" />
